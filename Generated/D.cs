...
file unsafe class ClassInformation : IComExposedClass
{
    ...
    static unsafe ComWrappers.ComInterfaceEntry* IComExposedClass.ComInterfaceEntries
    {
        get
        {
            if (_entries == null)
            {
                ComWrappers.ComInterfaceEntry* vtable = (ComWrappers.ComInterfaceEntry*)RuntimeHelpers.AllocateTypeAssociatedMemory(typeof(D), sizeof(ComWrappers.ComInterfaceEntry) * 2);
                ...
                details = StrategyBasedComWrappers.DefaultIUnknownInterfaceDetailsStrategy.GetIUnknownDerivedDetails(typeof(IComInterface4).TypeHandle)!;
